                        ...
                        .Element("Content")
                            ...
                            .Element("Padding")
                                ...
                                .Element("Preview Opacity Row")
                                    ...
                                    .Done
                                    .Element_Slider("Preview Opacity Slider", Config.Preview.previewAlpha.value, 0.0f, 1.0f, (value) => { Config.Preview.previewAlpha.value = value; _tool.SetPlaceholderOpacity(value); })
                                        .Layout()
                                            .MinWidth(200)
                                            .MinHeight(40)
                                            .FlexibleWidth(1)
