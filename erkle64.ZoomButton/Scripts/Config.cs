...
namespace ZoomButton
{
    ...
    public static class Config
    {
        ...
        {
            [ModSettingTitle("Zoom Factor")]
            public static ModSetting<float> zoomFactor = 5f;
        }
        ...
        {
            [ModSettingTitle("Zoom Key")]
            public static ModSetting<KeyCode> zoomKey = KeyCode.BackQuote;
        }
    }
